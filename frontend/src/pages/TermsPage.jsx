      ...
      <div className="max-w-[800px] mx-auto pb-20">
        <div className="brutal-card bg-surface p-8 mb-8 border-4 border-text shadow-brutal-lg">
          <div className="flex items-center gap-4 mb-6 border-b-4 border-text pb-4">
            <div className="p-3 bg-warning border-4 border-text rounded-lg">
              <BookOpen size={32} />
            </div>
            <h1 className="text-3xl md:text-5xl font-geist font-black uppercase tracking-tight">Terms of Service</h1>
          </div>
          ...
          <div className="space-y-6 font-medium text-lg leading-relaxed">
            ...
            <section className="space-y-3">
              <h2 className="text-2xl font-bold uppercase border-b-2 border-text inline-block mb-2">1. Acceptance of Terms</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-2xl font-bold uppercase border-b-2 border-text inline-block mb-2">2. Google Account Usage</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-2xl font-bold uppercase border-b-2 border-text inline-block mb-2">3. Acceptable Use</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-2xl font-bold uppercase border-b-2 border-text inline-block mb-2">4. Termination</h2>
