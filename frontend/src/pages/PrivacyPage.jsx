      ...
      <div className="max-w-[800px] mx-auto pb-20">
        <div className="brutal-card bg-surface p-8 mb-8 border border-border shadow-elevated">
          <div className="flex items-center gap-4 mb-6 border-b border-border pb-4">
            ...
            <h1 className="text-3xl md:text-5xl font-geist font-bold uppercase tracking-tight">Privacy Policy</h1>
          </div>
          ...
          <div className="space-y-6 font-medium text-lg leading-relaxed">
            ...
            <section className="space-y-3">
              <h2 className="text-2xl font-bold uppercase border-b border-border inline-block mb-2">1. Information We Collect</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-2xl font-bold uppercase border-b border-border inline-block mb-2">2. How We Use Your Information</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-2xl font-bold uppercase border-b border-border inline-block mb-2">3. Data Security & Storage</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-2xl font-bold uppercase border-b border-border inline-block mb-2">4. Your Rights</h2>
